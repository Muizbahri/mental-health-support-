            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-2 rounded-lg border ${form.icNumber && form.icNumber.length !== 12 ? 'border-red-300 focus:ring-red-200' : 'border-gray-200 focus:ring-teal-200'} focus:outline-none focus:ring-2 text-gray-700 bg-gray-50`}
                  value={form.icNumber}
